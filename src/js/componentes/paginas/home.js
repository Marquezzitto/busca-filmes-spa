async function home(app) {
  app.innerHTML = `
    <section class="pagina">
      ...
      <p class="pagina__descricao">Sua plataforma para explorar filmes e séries reais em tempo real.</p>

      <div class="bem-grid-auto">
        <div class="bem-card">
          <div class="bem-card__icone">🎬</div>
          <h2 class="bem-card__title">Filmes</h2>
          <p>Confira grandes sucessos e clássicos do cinema.</p>
          <br>
        ...
        <div class="bem-card">
          ...
          <p>Descubra novas séries, animes e novelas.</p>
          <br>
